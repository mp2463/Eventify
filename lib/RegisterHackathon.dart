...
class RegisterHackathon extends StatefulWidget {
  const RegisterHackathon({super.key});
  ...
  @override
  State<RegisterHackathon> createState() => _RegisterHackathonPageState();
...
class _RegisterHackathonPageState extends State<RegisterHackathon> {
